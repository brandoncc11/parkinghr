...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post parkings_url, params: { parking: { addres: @parking.addres, name: @parking.name, phone: @parking.phone, quota: @parking.quota } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { addres: @parking.addres, name: @parking.name, phone: @parking.phone, quota: @parking.quota } }
